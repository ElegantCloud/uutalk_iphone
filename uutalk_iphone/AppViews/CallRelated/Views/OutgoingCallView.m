...
- (void)terminateSipVoiceCall:(NSNumber *)terminatedType;
...
- (void)setSipImplementation:(id<ISipProtocol>)sipImplementation{
    NSLog(@"setSipImplementation: %@", [sipImplementation description]);
...
- (void)onCallTerminated{
    ...
    if (!_mIsHanguping) {
        ...
        [self terminateSipVoiceCall:[NSNumber numberWithInt:PASSIVE]];
    }
}
...
- (void)terminateSipVoiceCall:(NSNumber *)terminatedType{
    ...
    switch (terminatedType.intValue) {
        case INITIATIVE:
            // hangup current sip voice call
            NSLog(@"_mSipImplementation: %@", _mSipImplementation);
