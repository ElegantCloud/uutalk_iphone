...
- (void)doCardChargeCardInfo:(NSDictionary *)cardInfo {
    ...
    [HttpUtils postSignatureRequestWithUrl:CARD_CHARGE_URL andPostFormat:urlEncoded andParameter:params andUserInfo:nil andRequestType:synchronous andProcessor:self andFinishedRespSelector:@selector(onFinishedTopup:) andFailedRespSelector:nil];
