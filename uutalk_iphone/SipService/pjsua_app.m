...
void console_app_main(const pj_str_t *uri_to_call)
{
    ...
    // self defined sip operations
    pj_status_t register_sip_account(char *acc_uri, char *registrar_uri, char *realm, char *username, char *pwd) {
        pjsua_acc_config acc_cfg;
        pj_status_t status;

        pjsua_acc_config_default(&acc_cfg);
        acc_cfg.id = pj_str(acc_uri);
